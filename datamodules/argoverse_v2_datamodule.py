...
from transforms import TargetBuilder, TargetBuilder_ssl, LaneRandomOcclusion
...
class ArgoverseV2DataModule(pl.LightningDataModule):
    ...
    def __init__(self,
        ...
        if is_pretrain:
            self.train_transform = Compose([LaneRandomOcclusion(0.5), TargetBuilder_ssl(50, 60)])
            self.val_transform = Compose([TargetBuilder_ssl(50, 60)])
    ...
    def train_dataloader(self):
        return DataLoader(self.train_dataset, batch_size=self.train_batch_size, shuffle=self.shuffle,
                          ...
                          worker_init_fn=getattr(self.trainer.lightning_module, "worker_init_fn", None) if self.is_pretrain else None)
